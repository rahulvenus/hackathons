...
public class Connect4Field implements Connect4FieldInterface{
	...
	public  int rows = 6;
	public  int coloumns = 14;
	public  char[][] board= new char[rows][coloumns];
	...
	/**
	 * This is the  method to check if pieces Can Be DroppedIn	to the
	 ...
	 public void playTheGame(){
		 while((totalSlots-freeSlots) < 6){
			 ...
			 if(player2.getName().equals("Computer")){
				 lastColumn = player2.nextComputerMove();
			 }
			 else
				 player2.nextMove();
		 }
